...
export const PROJECTS: Project[] = [
  {
    ...
    coverImage: "/images/high-gain-dc-dc-converter-3.jpg",
    images: [
      { src: "/images/high-gain-dc-dc-converter-3.jpg", caption: "Converter 1 (Topology A) — Single-Switch High-Gain Boost Converter PCB" },
      { src: "/images/high-gain-dc-dc-converter-2.jpg", caption: "Converter 2 (Topology B) — Synchronized Dual-Switch High-Gain Converter PCB" },
      { src: "/images/high-gain-dc-dc-converter-1.jpg", caption: "Converter 2 — PCB Hardware & Hand-Wound ETD Core Magnetics Detail" },
      { src: "/images/high-gain-dc-dc-testbench.jpg", caption: "Bench Validation Setup — Oscilloscope, Differential Probes & High-Voltage DC Supply" },
    ],
  },
  {
    slug: "lotus",
  ...
  },
  {
    ...
    coverImage: "/images/rocket-avionics/Full_FC_side.jpg",
    images: [
      { src: "/images/rocket-avionics/Full_FC_side.jpg", caption: "Full Avionics Stack — Multi-Layer SMD Assembly Side View" },
      { src: "/images/rocket-avionics/EPS_Style.jpg", caption: "Payload EPS + Flight Computer — Combined Power Distribution PCB" },
      { src: "/images/rocket-avionics/FC_Heroic.jpg", caption: "Rocket Flight Computer — Main Board Stack & Telemetry Controller" },
      { src: "/images/rocket-avionics/FC_top.jpg", caption: "Flight Computer PCB — Top Component Placement & Microcontroller" },
      { src: "/images/rocket-avionics/FC_bottom.jpg", caption: "Flight Computer PCB — Bottom Trace Routing & SMD Decoupling" },
      { src: "/images/rocket-avionics/FC_bottom_side.jpg", caption: "Flight Computer PCB — Angled Bottom Layer & Hardware Detail" },
    ],
  },
  {
    ...
    coverImage: "/images/gesture-controlled-wheelchair/wheelchair.jpg",
    images: [
      { src: "/images/gesture-controlled-wheelchair/wheelchair.jpg", caption: "Gesture-Controlled Wheelchair Prototype — Motor Driver & Ultrasonic Sensors" },
      { src: "/images/gesture-controlled-wheelchair/remote.jpg", caption: "Gesture Remote Module — ESP32 & MPU6050 Motion Tracking Unit" },
    ],
  },
  {
    slug: "pocket-alt",
    ...
    coverImage: "/images/pocket-alt/pocketAlt_hero.jpg",
    images: [
      { src: "/images/pocket-alt/pocketAlt_hero.jpg", caption: "Pocket Alt — Handheld Toss-and-Play Altimeter with OLED Telemetry Display" },
      { src: "/images/pocket-alt/pocketAlt_top.jpg", caption: "Pocket Alt PCB — STM32F401 MCU, BMP280 Barometric Pressure Sensor & SSD1306 OLED" },
      { src: "/images/pocket-alt/pocketAlt_side.jpg", caption: "Pocket Alt — Compact Hardware Profile & Handheld Form Factor" },
      { src: "/images/pocket-alt/pocketAlt_back.jpg", caption: "Pocket Alt PCB — On-Chip Flash Logging & LiPo Battery Power Connection" },
    ],
  },
];
