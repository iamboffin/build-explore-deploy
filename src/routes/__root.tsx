  ...
  head: () => ({
    meta: [
      ...
      { title: "Dharani Barathi C D — Power Electronics & Avionics Engineer" },
      {
        name: "description",
        content:
          "Portfolio of Dharani Barathi C D — power electronics researcher, avionics engineer, and inventor. High-gain DC-DC converters, rocket flight computers, ToF measurement systems.",
      },
      { name: "author", content: "Dharani Barathi C D" },
      { property: "og:title", content: "Dharani Barathi C D — Power Electronics & Avionics" },
      {
        property: "og:description",
        content:
          "2 patents, 1 IEEE paper, rocket avionics, and a new class of measurement instrument. Selected work from VIT Chennai.",
      },
