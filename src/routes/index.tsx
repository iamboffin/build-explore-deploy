...
function ContactForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setState("submitting");
    try {
      // 1. Automatically send email to dharanibarathicd@gmail.com in background
      await fetch("https://formsubmit.co/ajax/dharanibarathicd@gmail.com", {
        method: "POST",
        headers: {
      ...
      // 2. Backup to Supabase contact_submissions table
      try {
        ...
        // Silently handle database backup
      }
